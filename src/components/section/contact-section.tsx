...
export default function ContactSection() {
  return (
    <div className="w-full border border-border/80 bg-card/60 backdrop-blur-xl rounded-2xl p-8 sm:p-10 flex flex-col items-center justify-center text-center gap-4 shadow-xs relative overflow-hidden">
      <div className="p-3 rounded-full border border-red-500/30 bg-red-500/10 text-red-400">
      ...
      <div className="flex flex-col gap-1 items-center">
        ...
        <Link
          ...
          className="text-lg sm:text-2xl font-bold text-foreground hover:text-red-400 transition-colors font-mono underline underline-offset-4"
        >
          {DATA.contact.email}
        </Link>
      </div>
