...
function CodeBlockClient({ children, ...props }: CodeBlockProps) {
  ...
  useEffect(() => {
    ...
    const SHIKI_URL = "https://esm.sh/shiki@3.20.0";
    import(/* webpackIgnore: true */ SHIKI_URL)
      .then((mod) =>
        mod.codeToHtml(codeText, {
          lang: lang as any,
          themes: {
            light: "github-light",
            dark: "github-dark",
...
export const CodeBlock = dynamic(() => Promise.resolve(CodeBlockClient), {
  ssr: false,
  loading: () => null,
});
