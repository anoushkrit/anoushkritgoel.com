          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-base font-semibold text-cyan-400 mt-0.5">{work.title}</p>
              </div>
            </div>

            <div className="flex flex-col sm:items-end gap-1 font-mono text-xs text-muted-foreground">
              <span className="text-cyan-400 font-semibold bg-cyan-500/10 px-3 py-1 rounded-full border border-cyan-500/30">
                {work.start} — {work.end}
              </span>
